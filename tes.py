...
def app():
    ...
    thershold =st.text_input(label ='Pleas inter the thershold')
    ...
    if bg_video is not None:
        ...
        out = cv2.VideoWriter('quq.avi',fourcc, 5, (640,640))
        ...
        generator = sv.get_video_frames_generator('quq.avi')  
        ...
        #///////////end of ROI//////////////
                ...
                if len(var.poly) > 0:
                    ...
                    s= len(polygons)
                    video_info = sv.VideoInfo.from_video_path('quq.avi')
                    zones = [
                        sv.PolygonZone(
                            polygon=polygon, 
                ...
                #total count for each zones:
                    ...
                    def process_frame(frame: np.ndarray, _) -> np.ndarray:
                            ...
                            for zone, zone_annotator, box_annotator in zip(zones, zone_annotators, box_annotators):
                                ...
                                if total_preZone[zone]> thershold:
                                    current_frame[zone]=[]
                            return frame

                    
                        #sv.show_frame_in_notebook(frame, (16, 16))
                    sv.process_video(source_path='quq.avi', target_path=f"/Users/khawlahd/Desktop/cv/my-venv/que-result.mp4", callback=process_frame)
                    total=0
